...
public:
	 ...
	 *
	 * @param res, the object obtained from the stream, moved into.
	 *
	 * @return true if the next object was successfully retrieved.
	 * @return false if the stream has finished and no new objects are available.
	 */
	 ...
	 *
	 * @param res, the object pushed to the stream, moved from.
	 */
	...
	/**
	 * Determine if the stream is finished completely.
	 *
	 * @return true iff all objects have been collected and no more are ever coming.
	 */
	bool isFinished() {
		bool noMoreObjects;
		synchronized_nonrecursive(m_mutex) {
